                ...
                <div className='user'>
                    ...
                    <span className='following'>
                        <span>
                            ...
                            <h3 className='title' style={titleStyle}>{user.followers.total > 1 || user.followers.total === 0 ? 'followers' : 'follower'}</h3>
                        </span>
                        {followedArtists !== null ? (
                            <span>
                                <h3 className='text'>{followedArtists.artists.items.length}</h3>
                                <h3 className='title' style={titleStyle}>following</h3>
                            </span>
